...
import '../svc/otras_cartillas_text.dart';

class OtrasCartillasForm extends StatefulWidget {
  final AppUser? user;
  final ValueChanged<String>? onPreviewChanged;
  final VoidCallback? onGenerate;
  final bool generando;

  const OtrasCartillasForm({
    super.key,
    this.user,
  ...
  @override
  State<OtrasCartillasForm> createState() => OtrasCartillasFormState();
}

class OtrasCartillasFormState extends State<OtrasCartillasForm> {
  ...
  final _causaCtrl = TextEditingController(text: 'Novedad');
  ...
  void _actualizarPreview() {
    _previewText = OtrasCartillasText.build(
      OtrasCartillasData(
        servicio: _servicio,
        ...
        novedades: _novedadesCtrl.text,
        moto: _servicio == 'MOTORIZADO' ? _motoCtrl.text : null,
        can: _servicio == 'K9' ? _canCtrl.text : null,
        bicicleta: _servicio == 'CICLISTA' ? _bicicletaCtrl.text : null,
        videoperador: _isRadioperador ? _videoperadorCtrl.text : null,
        movilesEnCirculacion:
            _needsEasDropdown ? (_movilesSeleccionados.toList()..sort()) : const [],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Registro de novedades según tipo de servicio',
  ...
  Widget _buildSection2() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionBadge(2, 'DETALLE DEL REPORTE'),
          const SizedBox(height: 16),
          ...
          TextFormField(
            ...
            decoration: _inputDeco(
              ...
              hint: 'Ej: Novedad, Incidencia, etc.',
            ),
            onChanged: (_) => _schedulePreviewUpdate(),
            validator: (value) => _required(value, 'Causa'),
          ),
          const SizedBox(height: 12),
          ...
          TextFormField(
            ...
            decoration: _inputDeco(
              ...
              hint: 'Describa detalladamente la novedad o incidencia...',
            ).copyWith(alignLabelWithHint: true),
            onChanged: (_) => _schedulePreviewUpdate(),
            validator: (value) => _required(value, 'Novedades'),
          ),
        ],
      ),
    );
  ...
  Widget _buildSection3() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionBadge(3, 'EVIDENCIA FOTOGRÁFICA'),
