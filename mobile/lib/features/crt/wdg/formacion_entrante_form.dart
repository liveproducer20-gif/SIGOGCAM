...
class FormacionEntranteForm extends StatefulWidget {
  final AppUser? user;
  final String jefeNombre;
  final ValueChanged<String>? onPreviewChanged;

  const FormacionEntranteForm({
    super.key,
    this.user,
  ...
  @override
  State<FormacionEntranteForm> createState() => _FormacionEntranteFormState();
}

class _FormacionEntranteFormState extends State<FormacionEntranteForm> {
  ...
  void _actualizarPreview() {
    ...
    // EAS/Radioperador: show EAS name instead of circuito
    ...
    final buf = StringBuffer()
      ...
      ..writeln('*CAUSA:* Formacion entrante')
      ..writeln()
      ..writeln('$saludo, permiso Sr. $jefe.')
      ..writeln()
      ..writeln(
        'Muy respetuosamente, me permito informar que se procedio con la formacion del personal entrante'
      ...
      ..writeln()
      ..writeln(
        'Asimismo, se informa que para el cumplimiento de las actividades operativas correspondientes se cuenta con el siguiente personal asignado:',
      )
      ..writeln()
      ..writeln('*$acm ACM*');
    ...
    // Service-specific reporta suffix
    switch (_servicio) {
      case 'MOTORIZADO':
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // Circuit (hidden for EAS/Radioperador)
            if (!_needsEasDropdown)
