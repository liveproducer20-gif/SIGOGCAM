            ...
            <div id="tdRouteWorkspace" hidden>
                ...
                <section class="td-managers-row">
                    ...
                    <section class="td-circuit-managers" id="tdCircuitManagersCard">
                        <header><div><small>RESPONSABILIDAD OPERATIVA</small><h3 id="tdCircuitManagersTitle">Encargados de circuito</h3></div><?php if ($canAssign): ?><button class="td-btn td-btn-primary td-btn-sm" id="tdAddCircuitManager" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg><span class="td-btn-label">Agregar</span></button><?php endif; ?></header>
                    ...
                    <section class="td-manager-card td-route-manager" id="tdRouteManagerCard" hidden>
                        <div><small>RESPONSABILIDAD DE LA RUTA</small><h3 id="tdRouteManagerCardTitle">Responsabilidad de ruta</h3><div id="tdRouteManagerValue"><div class="td-empty-role"><span class="td-avatar--ghost"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span><div><b>Cargando</b><small>Espere un momento</small></div></div></div>
                        <?php if ($canAssign): ?><div class="td-manager-actions"><label class="td-manager-switch"><input id="tdRouteManagerRequired" type="checkbox"><span></span> <span id="tdRouteManagerRequiredLabel">Asignar encargado</span></label><button class="td-btn td-btn-primary td-btn-sm" id="tdAssignRouteManager" type="button" hidden><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span class="td-btn-label">Seleccionar agente</span></button><button class="td-btn td-btn-ghost td-btn-sm" id="tdAssignRouteManager2" type="button" hidden><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg><span class="td-btn-label">Agregar 2do</span></button><button class="td-btn td-btn-danger td-btn-sm" id="tdRemoveRouteManager2" type="button" hidden><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v5M14 11v5"/></svg><span class="td-btn-label">Quitar 2do</span></button></div><?php endif; ?>
                    </section>
                </section>
